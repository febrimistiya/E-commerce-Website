    ...
    <div class="row px-xl-5">
        <div class="col-lg-7 mb-5">
            <div class="contact-form">
                <form name="sentMessage" method="post" action="<?php echo site_url('Toko/save'); ?>"
                    ...
                    <div>
                        <button class="btn btn-primary text-white py-2 px-4" type="submit"
                            id="sendMesrsageButton">Tambah</button>
                    </div>
                </form>
            </div>
        </div>
