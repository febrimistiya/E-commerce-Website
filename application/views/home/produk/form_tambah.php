<div class="container-fluid pt-5">
        <div class="text-center mb-4">
            <h2 class="section-title px-5"><span class="px-2">Tambah Produk</span></h2>
        </div>
            ...
            <div class="col-lg-7 mb-5">
                <div class="contact-form">   
					...
					<div class="control-group">
                        ...
                        <div>
                            <button class="btn btn-primary text-white py-2 px-4" type="submit" id="sendMesrsageButton">Tambah</button>
                        </div>
                    </form>
                </div>
            </div>
